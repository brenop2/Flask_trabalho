...
app.config['MQTT_USERNAME'] = 'breno'  # Set this item when you need to verify username and password
app.config['MQTT_PASSWORD'] = '1234'  # Set this item when you need to verify username and password
